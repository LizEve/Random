...
setwd("/Users/ChatNoir/Projects/Squam/RevBayes/heated_emp/mbEmpTrees")

# read in the nexus file and name the outfile
genes <- c("ADNP", "AHR")

genes <- c("CAND1.nex.run1", "CAND1.nex.run2", "CAND1.nex.run3", "CAND1.nex.run4", "GHSR.nex.run1", "GHSR.nex.run2", "GHSR.nex.run3", "GHSR.nex.run4")
